...
| Feature                                 | Non-null Count and Type  | 
| --------------------------------------- | ------------------------ |
...
| Sub-Company response to consumer        | 871873 non-null object   | 
...
(1) There are **871873** records, **18** columns in the dataset. <br>
...
Since consumer's consents are provided **after** the complaint was processed, I will remove this variable. So will the other 3 variables: 'Company response to consumer', 'Consumer disputed?', and 'Complaint ID'.
```python
...
Columns remained in the dataframe:<br>
Index(['Date received', 'Product', 'Sub-product', 'Issue', 'Sub-issue',  'Consumer complaint narrative', 'Company public response', 'Company', 'State', 'ZIP code', 'Tags', 'Submitted via', 'Date sent to company', 'Timely response?', 'Complaint ID'], dtype='object')<br>
...
Rename the dependent variable as **'y'**:
```python
...
Since the missing rate is 27%, I will remove this variable from further analysis:
```python
...
Use **mean encoding** to deal with the 4393 different companies in the dataset. <br>
Define a function for mean encoding:
...
Apply mean encoding to the categorical variable 'Company':
```python
...
Shapes before/after deleting: (871873, 13)/(860657, 13). Apply mean encoding to the categorical variable 'State'. Since the information provided by 'ZIP code' is very similar to the variable 'State', I will remove the variable 'ZIP code' for the following analysis:
```python
# mean encoding
...
Display the top 3 rows of the new dataframe:
...
Exhibit descriptive statistics for all continuous variables in the dataset:
<div style="overflow-x: scroll;">
<style>
    .dataframe thead tr:only-child th {
        text-align: right;
...
Number of records with a duration greater than 250 days: 458. It accounts for 0.05% of the dataset. I will keep observations with long duration values for now.
...
Leverage the following function **bar_class_var()** to plot bar chart for any categorical variable.
```python
...
For example, we can apply the function to the categorical variable 'Weekday':
```python
...
Variables in the dataset df: <br>
...
Top 3 rows in the new dataframe:
<div style="overflow-x: auto;">
<style>
    .dataframe thead tr:only-child th {
        text-align: right;
...
Display the top 3 rows in the new dataframe:
<div style="overflow-x: scroll;">
<style>
    .dataframe thead tr:only-child th {
        text-align: right;
...
There are 30 columns in the new dataframe.
...
Variables in the dataset df2: <br>
...
Drop variables to aviod collinearity during the model development process:
```python
...
**Step 1**: Fit a baseline Logistic model.
```python
# Prepare data
train = df2.copy()
...
[[ 0.232   0.768 ]<br>
[ 0.0029  0.9971]]<br>
AUC Score : Mean - 0.8461 | Std - 0.0067 | Min - 0.8368 | Max - 0.8537<br>
Elapsed time is: 27.02 s.<br>
...
[[ 0.2322  0.7678]<br>
[ 0.0029  0.9971]]<br>
AUC Score : Mean - 0.8520 | Std - 0.0069 | Min - 0.8407 | Max - 0.8589<br>
Elapsed time is: 25.09 s.<br>
...
[[ 0.6444  0.3556]<br>
[ 0.0836  0.9164]]<br>
AUC Score : Mean - 0.8701 | Std - 0.0083 | Min - 0.8585 | Max - 0.8783<br>
Elapsed time is: 41.20 s.<br>
...
Check variables with values greater than 1 or less than 0 based on the following table:
<div style="overflow-x: scroll;">
<table border="1" class="dataframe">
  <thead>
    <tr style="text-align: left;">
...
As shown above, the variables **'Duration'** and **'State_pred_0'** are not distributed between 0 and 1.
...
Define a function to facilitate the parameter tunning pricess in GBMs.
```python
...
Model Report for baselie GBM model :<br>
Precision for Class 0 and Class 1 are 0.2178 and 0.9978<br>
AUC Score : 0.907908<br>
...
Model Report for baselie GBM model (accounting for sample weight):<br>
Precision for Class 0 and Class 1 are 0.8154 and 0.8511<br>
AUC Score : 0.912957<br>
...
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 1000) :<br>
Precision for Class 0 and Class 1 are 0.9980 and 0.2513<br>
AUC Score : 0.908325<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 500) :<br>
Precision for Class 0 and Class 1 are 0.9927 and 0.3219<br>
AUC Score : 0.909087<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 200) :<br>
Precision for Class 0 and Class 1 are 0.9755 and 0.4943<br>
AUC Score : 0.911110<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 150) :<br>
Precision for Class 0 and Class 1 are 0.9692 and 0.5304<br>
AUC Score : 0.910829<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 100) :<br>
Precision for Class 0 and Class 1 are 0.9454 and 0.6223<br>
AUC Score : 0.911321<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 90) :<br>
Precision for Class 0 and Class 1 are 0.9378 and 0.6480<br>
AUC Score : 0.911641<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 80) :<br>
Precision for Class 0 and Class 1 are 0.9305 and 0.6677<br>
AUC Score : 0.911768<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 70) :<br>
Precision for Class 0 and Class 1 are 0.9153 and 0.6986<br>
AUC Score : 0.911412<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 60) :<br>
Precision for Class 0 and Class 1 are 0.8942 and 0.7500<br>
AUC Score : 0.913415<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 50) :<br>
Precision for Class 0 and Class 1 are 0.8727 and 0.7846<br>
AUC Score : 0.912726<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 40) :<br>
Precision for Class 0 and Class 1 are 0.8261 and 0.8396<br>
AUC Score : 0.912782<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 30) :<br>
Precision for Class 0 and Class 1 are 0.7803 and 0.8781<br>
AUC Score : 0.912607<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 20) :<br>
Precision for Class 0 and Class 1 are 0.7353 and 0.9028<br>
AUC Score : 0.912381<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 10) :<br>
Precision for Class 0 and Class 1 are 0.5817 and 0.9556<br>
AUC Score : 0.911798<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 5) :<br>
Precision for Class 0 and Class 1 are 0.4524 and 0.9801<br>
AUC Score : 0.911981<br>
Model Report for baselie GBM model (adjusting parameter Weight Class 0 = 1) :<br>
Precision for Class 0 and Class 1 are 0.2178 and 0.9978<br>
AUC Score : 0.907908<br>
...
Model Report for parameter n_estimators = 30 :<br>
Precision for Class 0 and Class 1 are 0.7232 and 0.9076<br>
AUC Score : 0.910923<br>
Model Report for parameter n_estimators = 60 :<br>
Precision for Class 0 and Class 1 are 0.7318 and 0.9075<br>
AUC Score : 0.914343<br>
Model Report for parameter n_estimators = 90 :<br>
Precision for Class 0 and Class 1 are 0.7399 and 0.9071<br>
AUC Score : 0.916124<br>
Model Report for parameter n_estimators = 120 :<br>
Precision for Class 0 and Class 1 are 0.7429 and 0.9070<br>
AUC Score : 0.917319<br>
Model Report for parameter n_estimators = 150 :<br>
Precision for Class 0 and Class 1 are 0.7413 and 0.9076<br>
AUC Score : 0.918147<br>
Model Report for parameter n_estimators = 180 :<br>
Precision for Class 0 and Class 1 are 0.7409 and 0.9086<br>
AUC Score : 0.918171<br>
Model Report for parameter n_estimators = 210 :<br>
Precision for Class 0 and Class 1 are 0.7396 and 0.9092<br>
AUC Score : 0.918042<br>
Model Report for parameter n_estimators = 240 :<br>
Precision for Class 0 and Class 1 are 0.7397 and 0.9090<br>
AUC Score : 0.918055<br>
Model Report for parameter n_estimators = 270 :<br>
Precision for Class 0 and Class 1 are 0.7379 and 0.9095<br>
AUC Score : 0.917794<br>
Model Report for parameter n_estimators = 300 :<br>
Precision for Class 0 and Class 1 are 0.7372 and 0.9099<br>
AUC Score : 0.917351<br>
Model Report for parameter n_estimators = 330 :<br>
Precision for Class 0 and Class 1 are 0.7345 and 0.9104<br><br>
AUC Score : 0.917000<br>
Model Report for parameter n_estimators = 360 :<br>
Precision for Class 0 and Class 1 are 0.7306 and 0.9109<br>
AUC Score : 0.916668<br>
Model Report for parameter n_estimators = 390 :<br>
Precision for Class 0 and Class 1 are 0.7298 and 0.9116<br>
AUC Score : 0.916312<br>
...
Model Report for parameter num_samples_splits = 200, max_depths = 3 : <br>
Precision for Class 0 and Class 1 are 0.7137 and 0.9094 <br>
AUC Score : 0.907831 <br>
Model Report for parameter num_samples_splits = 200, max_depths = 5 : <br>
Precision for Class 0 and Class 1 are 0.7367 and 0.9051 <br>
AUC Score : 0.915751 <br>
Model Report for parameter num_samples_splits = 200, max_depths = 7 : <br>
Precision for Class 0 and Class 1 are 0.7413 and 0.9066 <br>
AUC Score : 0.917267 <br>
Model Report for parameter num_samples_splits = 200, max_depths = 9 : <br>
Precision for Class 0 and Class 1 are 0.7291 and 0.9102 <br>
AUC Score : 0.916031 <br>
Model Report for parameter num_samples_splits = 200, max_depths = 11 : <br>
Precision for Class 0 and Class 1 are 0.7130 and 0.9158 <br>
AUC Score : 0.912628 <br>
Model Report for parameter num_samples_splits = 200, max_depths = 13 : <br>
Precision for Class 0 and Class 1 are 0.6916 and 0.9212 <br>
AUC Score : 0.909359 <br>
Model Report for parameter num_samples_splits = 400, max_depths = 3 : <br>
Precision for Class 0 and Class 1 are 0.7137 and 0.9097 <br>
AUC Score : 0.907569 <br>
Model Report for parameter num_samples_splits = 400, max_depths = 5 : <br>
Precision for Class 0 and Class 1 are 0.7365 and 0.9070 <br>
AUC Score : 0.915628 <br>
Model Report for parameter num_samples_splits = 400, max_depths = 7 : <br>
Precision for Class 0 and Class 1 are 0.7426 and 0.9066 <br>
AUC Score : 0.918046 <br>
Model Report for parameter num_samples_splits = 400, max_depths = 9 : <br>
Precision for Class 0 and Class 1 are 0.7296 and 0.9113 <br>
AUC Score : 0.915709 <br>
Model Report for parameter num_samples_splits = 400, max_depths = 11 : <br>
Precision for Class 0 and Class 1 are 0.7249 and 0.9144 <br>
AUC Score : 0.913779 <br>
Model Report for parameter num_samples_splits = 400, max_depths = 13 : <br>
Precision for Class 0 and Class 1 are 0.7024 and 0.9191 <br>
AUC Score : 0.910562 <br>
Model Report for parameter num_samples_splits = 600, max_depths = 3 : <br>
Precision for Class 0 and Class 1 are 0.7140 and 0.9094 <br>
AUC Score : 0.907463 <br>
Model Report for parameter num_samples_splits = 600, max_depths = 5 : <br>
Precision for Class 0 and Class 1 are 0.7379 and 0.9069 <br>
AUC Score : 0.916034 <br>
Model Report for parameter num_samples_splits = 600, max_depths = 7 : <br>
Precision for Class 0 and Class 1 are 0.7423 and 0.9064 <br>
AUC Score : 0.918287 <br>
Model Report for parameter num_samples_splits = 600, max_depths = 9 : <br>
Precision for Class 0 and Class 1 are 0.7343 and 0.9100 <br>
AUC Score : 0.916762 <br>
Model Report for parameter num_samples_splits = 600, max_depths = 11 : <br>
Precision for Class 0 and Class 1 are 0.7218 and 0.9127 <br>
AUC Score : 0.913994 <br>
Model Report for parameter num_samples_splits = 600, max_depths = 13 : <br>
Precision for Class 0 and Class 1 are 0.7103 and 0.9165 <br>
AUC Score : 0.910933 <br>
Model Report for parameter num_samples_splits = 800, max_depths = 3 : <br>
Precision for Class 0 and Class 1 are 0.7113 and 0.9094 <br>
AUC Score : 0.906684 <br>
Model Report for parameter num_samples_splits = 800, max_depths = 5 : <br>
Precision for Class 0 and Class 1 are 0.7348 and 0.9056 <br>
AUC Score : 0.914983 <br>
Model Report for parameter num_samples_splits = 800, max_depths = 7 : <br>
Precision for Class 0 and Class 1 are 0.7456 and 0.9060 <br>
AUC Score : 0.918087 <br>
Model Report for parameter num_samples_splits = 800, max_depths = 9 : <br>
Precision for Class 0 and Class 1 are 0.7387 and 0.9087 <br>
AUC Score : 0.917499 <br>
Model Report for parameter num_samples_splits = 800, max_depths = 11 : <br>
Precision for Class 0 and Class 1 are 0.7296 and 0.9108 <br>
AUC Score : 0.914519 <br>
Model Report for parameter num_samples_splits = 800, max_depths = 13 : <br>
Precision for Class 0 and Class 1 are 0.7146 and 0.9144 <br>
AUC Score : 0.912088 <br>
Model Report for parameter num_samples_splits = 1000, max_depths = 3 : <br>
Precision for Class 0 and Class 1 are 0.7108 and 0.9097 <br>
AUC Score : 0.906866 <br>
Model Report for parameter num_samples_splits = 1000, max_depths = 5 : <br>
Precision for Class 0 and Class 1 are 0.7357 and 0.9061 <br>
AUC Score : 0.915788 <br>
Model Report for parameter num_samples_splits = 1000, max_depths = 7 : <br>
Precision for Class 0 and Class 1 are 0.7468 and 0.9060 <br>
AUC Score : 0.918461 <br>
Model Report for parameter num_samples_splits = 1000, max_depths = 9 : <br>
Precision for Class 0 and Class 1 are 0.7414 and 0.9076 <br>
AUC Score : 0.917992 <br>
Model Report for parameter num_samples_splits = 1000, max_depths = 11 : <br>
Precision for Class 0 and Class 1 are 0.7296 and 0.9111 <br>
AUC Score : 0.915715 <br>
Model Report for parameter num_samples_splits = 1000, max_depths = 13 : <br>
Precision for Class 0 and Class 1 are 0.7193 and 0.9134 <br>
AUC Score : 0.913431 <br>
...
Model Report for parameter min_samples_leafs = 10 : <br>
Precision for Class 0 and Class 1 are 0.7455 and 0.9063 <br>
AUC Score : 0.918092 <br>
Model Report for parameter min_samples_leafs = 20 : <br>
Precision for Class 0 and Class 1 are 0.7445 and 0.9064 <br>
AUC Score : 0.918070 <br>
Model Report for parameter min_samples_leafs = 50 : <br>
Precision for Class 0 and Class 1 are 0.7406 and 0.9069 <br>
AUC Score : 0.918106 <br>
Model Report for parameter min_samples_leafs = 100 : <br>
Precision for Class 0 and Class 1 are 0.7468 and 0.9060 <br>
AUC Score : 0.918461 <br>
Model Report for parameter min_samples_leafs = 200 : <br>
Precision for Class 0 and Class 1 are 0.7472 and 0.9050 <br>
AUC Score : 0.917873 <br>
Model Report for parameter min_samples_leafs = 500 : <br>
Precision for Class 0 and Class 1 are 0.7502 and 0.9045 <br>
AUC Score : 0.918129 <br>
...
Model Report for parameter max_features = 1 : <br>
Precision for Class 0 and Class 1 are 0.7269 and 0.9061 <br>
AUC Score : 0.909455 <br>
Model Report for parameter max_features = 3 : <br>
Precision for Class 0 and Class 1 are 0.7336 and 0.9071 <br>
AUC Score : 0.914892 <br>
Model Report for parameter max_features = 5 : <br>
Precision for Class 0 and Class 1 are 0.7468 and 0.9060 <br>
AUC Score : 0.918461 <br>
Model Report for parameter max_features = 7 : <br>
Precision for Class 0 and Class 1 are 0.7473 and 0.9057 <br>
AUC Score : 0.920346 <br>
Model Report for parameter max_features = 9 : <br>
Precision for Class 0 and Class 1 are 0.7533 and 0.9060 <br>
AUC Score : 0.920981 <br> <br>
Model Report for parameter max_features = 11 : <br>
Precision for Class 0 and Class 1 are 0.7548 and 0.9050 <br> 
AUC Score : 0.921454 <br> <br>
Model Report for parameter max_features = 13 : <br>
Precision for Class 0 and Class 1 are 0.7544 and 0.9056 <br>
AUC Score : 0.922082 <br>
Model Report for parameter max_features = 15 : <br>
Precision for Class 0 and Class 1 are 0.7573 and 0.9052 <br> 
AUC Score : 0.922337 <br>
...
Model Report for parameter subsample_rates = 0.6 : <br>
Precision for Class 0 and Class 1 are 0.7536 and 0.9054 <br>
AUC Score : 0.921036 <br>
Model Report for parameter subsample_rates = 0.65 : <br>
Precision for Class 0 and Class 1 are 0.7527 and 0.9067 <br>
AUC Score : 0.920293 <br>
Model Report for parameter subsample_rates = 0.70 : <br>
Precision for Class 0 and Class 1 are 0.7521 and 0.9059 <br>
AUC Score : 0.920885 <br>
Model Report for parameter subsample_rates = 0.75 : <br>
Precision for Class 0 and Class 1 are 0.7546 and 0.9066 <br>
AUC Score : 0.921284 <br>
Model Report for parameter subsample_rates = 0.80: <br>
Precision for Class 0 and Class 1 are 0.7533 and 0.9060 <br>
AUC Score : 0.920981 <br>
Model Report for parameter subsample_rates = 0.85 : <br>
Precision for Class 0 and Class 1 are 0.7539 and 0.9067 <br>
AUC Score : 0.921666 <br>
Model Report for parameter subsample_rates = 0.90: <br>
Precision for Class 0 and Class 1 are 0.7538 and 0.9059 <br>
AUC Score : 0.921437 <br>
...
Model Report for parameter learning_rate = 0.05, n_estimators = 360 : <br>
Precision for Class 0 and Class 1 are 0.7541 and 0.9057 <br>
AUC Score : 0.921346 <br>
Elapsed time is: 566.26 s. <br>

Model Report for parameter learning_rate = 0.01, n_estimators = 1800 : <br>
Precision for Class 0 and Class 1 are 0.7539 and 0.9062 <br>
AUC Score : 0.921931 <br>
Elapsed time is: 2870.56 s. <br>

Model Report for parameter learning_rate = 0.005, n_estimators = 3600 : <br>
Precision for Class 0 and Class 1 are 0.7541 and 0.9063 <br>
AUC Score : 0.921945 <br>
Elapsed time is: 5721.00 s. <br>
