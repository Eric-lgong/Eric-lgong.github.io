...
Since consumer's consents are provided **after** the complaint was processed, I will remove this variable. So will 'Company response to consumer', 'Consumer disputed?', and 'Complaint ID'.
```python
...
Use **MeanEncoding** to deal with the 4393 different companies in the dataset? <br>
